...
def login():
    ...
    if request.method == 'GET':
        # Determine where to redirect the user if they are already logged in
        ...
        # Validate user credentials and redirect them to their initial destination
...
def student_create():
    ...
    # Address issue where an unsupported HTTP request method is attempted
    flash(f'Invalid request. Please contact support if this problem persists.', 'error')
    return redirect(url_for('student_view_all'))
